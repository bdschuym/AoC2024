...
fn main() {
    ...
    /*println!(
        "input: {:?}; disk_map: {:?}; empty_spaces: {:?}",
        input, disk_map, empty_spaces
    );*/
    //part1(&mut disk_map);
    // unoptimized part2 with puzzle input: about 0.63s
    //part2(&mut disk_map, file_lengths);
    // optimized part2_optimized with puzzle input: about 0.03s
